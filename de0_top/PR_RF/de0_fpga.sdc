...
create_clock -name {iFIFO_CLKOUT} -period 16.666 -waveform { 0.000 8.333 } [get_ports {iFIFO_CLKOUT}]

#**************************************************************
# Set Input Delay
#**************************************************************
set_min_delay 0.0 -from [get_ports {iEPCS_DATA0 }] -to *
set_max_delay 10.0 -from [get_ports {iEPCS_DATA0 }] -to *
...
# Set Output Delay
#**************************************************************
set_min_delay  0.0 -from * -to [get_ports { oEPCS* }]
set_max_delay  10.0 -from * -to [get_ports { oEPCS* }]
...
set_false_path -from [get_ports {iFIFO* ioFIFO_DAT[*]}] -to *
